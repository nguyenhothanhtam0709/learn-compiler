...
/// @brief Given a string with a '.' and at least a 1-character suffix
...
/// @brief Given an input filename, compile that file
...
/// @brief Given an input filename, assemble that file
...
/// @brief Given a list of object files and an output filename,
...
int main(int argc, char *argv[])
{
    ...
    // #region Initialise our variables
    O_dumpAST = 0;
    O_keepasm = 0;
    O_assemble = 0;
    O_verbose = 0;
    ...
    // #region Scan for command-line options
    for (i = 1; i < argc; i++)
    {
