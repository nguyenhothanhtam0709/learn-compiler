...
struct ASTnode *mkastnode(int op,
                          ...
                          struct symtable *sym,
                          int intvalue);
struct ASTnode *mkastleaf(int op,
                          int type,
                          struct symtable *sym,
                          int intvalue);
struct ASTnode *mkastunary(int op,
                           int type,
                           struct ASTnode *left,
                           struct symtable *sym,
                           int intvalue);
...
void appendsym(struct symtable **head,
               struct symtable **tail,
               struct symtable *node);
struct symtable *newsym(char *name,
                        int type,
                        int stype,
                        int class,
                        int size,
                        int posn);
struct symtable *addglob(char *name,
                         int type,
                         int stype,
                         int class,
                         int size);
struct symtable *addlocl(char *name,
                         int type,
                         int stype,
                         int class,
                         int size);
struct symtable *addparm(char *name,
                         int type,
                         int stype,
                         int class,
                         int size);
